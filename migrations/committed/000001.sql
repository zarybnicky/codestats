--! Previous: -
--! Hash: sha1:a418347695c4ac983df031bff794b28b0062741a
...
drop schema if exists mergestat cascade;
drop schema if exists sqlq cascade;
...
ALTER SCHEMA mergestat OWNER TO postgres;
ALTER SCHEMA public OWNER TO postgres;
ALTER SCHEMA sqlq OWNER TO postgres;
...
--
-- Name: job_states; Type: TYPE; Schema: sqlq; Owner: postgres
--
...
ALTER TYPE sqlq.job_states OWNER TO postgres;

--
-- Name: log_level; Type: TYPE; Schema: sqlq; Owner: postgres
--
...
ALTER TYPE sqlq.log_level OWNER TO postgres;

--
-- Name: add_repo_import(uuid, text, text, uuid[]); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.add_repo_import(provider_id uuid, import_type text, import_type_name text, default_container_image_ids uuid[]) OWNER TO postgres;
...
--
-- Name: service_auth_credentials; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.service_auth_credentials OWNER TO postgres;

--
-- Name: add_service_auth_credential(text, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.add_service_auth_credential(credential_type text, credentials text, secret text) OWNER TO postgres;

--
-- Name: add_service_auth_credential(uuid, text, text, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.add_service_auth_credential(provider_id uuid, credential_type text, username text, token text, secret text) OWNER TO postgres;

--
-- Name: sync_variables; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.sync_variables OWNER TO postgres;

--
-- Name: add_sync_variable(uuid, text, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.add_sync_variable(repo_id uuid, key text, value text, secret text) OWNER TO postgres;

--
-- Name: container_syncs; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.container_syncs OWNER TO postgres;

--
-- Name: container_syncs_latest_sync_runs(mergestat.container_syncs); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.container_syncs_latest_sync_runs(container_syncs mergestat.container_syncs) OWNER TO postgres;

--
-- Name: enable_container_sync(uuid, uuid); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.enable_container_sync(repo_id_param uuid, container_image_id uuid) OWNER TO postgres;

--
-- Name: fetch_service_auth_credential(uuid, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.fetch_service_auth_credential(provider_id uuid, credential_type text, secret text) OWNER TO postgres;

--
-- Name: fetch_sync_variable(uuid, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.fetch_sync_variable(uuid, text, text) OWNER TO postgres;

--
-- Name: get_repos_page_header_stats(); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.get_repos_page_header_stats() OWNER TO postgres;

--
-- Name: get_repos_syncs_by_status(uuid, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.get_repos_syncs_by_status(repo_id_param uuid, status_param text) OWNER TO postgres;

--
-- Name: repo_sync_queue; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_queue OWNER TO postgres;

--
-- Name: repo_sync_queue_has_error(mergestat.repo_sync_queue); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.repo_sync_queue_has_error(job mergestat.repo_sync_queue) OWNER TO postgres;

--
-- Name: set_current_timestamp_updated_at(); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.set_current_timestamp_updated_at() OWNER TO postgres;

--
-- Name: set_sync_job_status(text, bigint); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.set_sync_job_status(new_status text, repo_sync_queue_id bigint) OWNER TO postgres;

--
-- Name: simple_repo_sync_queue_cleanup(integer); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.simple_repo_sync_queue_cleanup(days_to_retain_param integer) OWNER TO postgres;

--
-- Name: simple_sqlq_cleanup(integer); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.simple_sqlq_cleanup(days_to_retain_param integer) OWNER TO postgres;

--
-- Name: sync_now(uuid); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.sync_now(container_sync_id uuid) OWNER TO postgres;

--
-- Name: update_repo_import_default_container_images(uuid, uuid[]); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.update_repo_import_default_container_images(repo_import_id uuid, default_container_image_ids uuid[]) OWNER TO postgres;

--
-- Name: user_mgmt_add_user(name, text, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.user_mgmt_add_user(username name, password text, role text) OWNER TO postgres;

--
-- Name: user_mgmt_remove_user(name); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.user_mgmt_remove_user(username name) OWNER TO postgres;

--
-- Name: user_mgmt_set_user_role(name, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.user_mgmt_set_user_role(username name, role text) OWNER TO postgres;

--
-- Name: user_mgmt_update_user_password(name, text); Type: FUNCTION; Schema: mergestat; Owner: postgres
--
...
ALTER FUNCTION mergestat.user_mgmt_update_user_password(username name, password text) OWNER TO postgres;

--
-- Name: current_merge_stat_user(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.current_merge_stat_user() OWNER TO postgres;

--
-- Name: explore_ui(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.explore_ui(params jsonb) OWNER TO postgres;

--
-- Name: getfilesolderthan(text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.getfilesolderthan(file_pattern text, older_than_days integer) OWNER TO postgres;
...
--
-- Name: repo_sync_queue_status_update_trigger(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.repo_sync_queue_status_update_trigger() OWNER TO postgres;
...
--
-- Name: TABLE repos; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.repo; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.ref; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.created_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.settings; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.tags; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN repos.repo_import_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: repos_stats(public.repos); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.repos_stats(repos public.repos) OWNER TO postgres;
...
--
-- Name: cancelling_job(uuid); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.cancelling_job(job_id uuid) OWNER TO postgres;

--
-- Name: check_job_status(uuid, sqlq.job_states); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.check_job_status(job_id uuid, state sqlq.job_states) OWNER TO postgres;

--
-- Name: jobs; Type: TABLE; Schema: sqlq; Owner: postgres
--
...
ALTER TABLE sqlq.jobs OWNER TO postgres;

--
-- Name: dequeue_job(text[], text[]); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.dequeue_job(queues text[], jobtypes text[]) OWNER TO postgres;

--
-- Name: mark_failed(uuid, sqlq.job_states, boolean, bigint); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.mark_failed(id uuid, expectedstate sqlq.job_states, retry boolean, run_after bigint) OWNER TO postgres;

--
-- Name: mark_success(uuid, sqlq.job_states); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.mark_success(id uuid, expectedstate sqlq.job_states) OWNER TO postgres;

--
-- Name: reap(text[]); Type: FUNCTION; Schema: sqlq; Owner: postgres
--
...
ALTER FUNCTION sqlq.reap(queues text[]) OWNER TO postgres;

--
-- Name: container_image_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.container_image_types OWNER TO postgres;

--
-- Name: container_images; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.container_images OWNER TO postgres;

--
-- Name: container_sync_executions; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.container_sync_executions OWNER TO postgres;

--
-- Name: container_sync_schedules; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.container_sync_schedules OWNER TO postgres;

--
-- Name: latest_repo_syncs; Type: VIEW; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.latest_repo_syncs OWNER TO postgres;

--
-- Name: providers; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.providers OWNER TO postgres;

--
-- Name: query_history; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.query_history OWNER TO postgres;

--
-- Name: repo_import_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_import_types OWNER TO postgres;

--
-- Name: TABLE repo_import_types; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_imports; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_imports OWNER TO postgres;

--
-- Name: TABLE repo_imports; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_log_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_log_types OWNER TO postgres;

--
-- Name: repo_sync_logs; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_logs OWNER TO postgres;

--
-- Name: repo_sync_logs_id_seq; Type: SEQUENCE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_logs_id_seq OWNER TO postgres;

--
-- Name: repo_sync_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue_id_seq; Type: SEQUENCE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_queue_id_seq OWNER TO postgres;

--
-- Name: repo_sync_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue_status_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_queue_status_types OWNER TO postgres;

--
-- Name: repo_sync_type_groups; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_type_groups OWNER TO postgres;

--
-- Name: repo_sync_type_label_associations; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_type_label_associations OWNER TO postgres;

--
-- Name: TABLE repo_sync_type_label_associations; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_labels; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_type_labels OWNER TO postgres;

--
-- Name: TABLE repo_sync_type_labels; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_sync_types OWNER TO postgres;

--
-- Name: repo_syncs; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.repo_syncs OWNER TO postgres;

--
-- Name: saved_explores; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.saved_explores OWNER TO postgres;

--
-- Name: TABLE saved_explores; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_explores.created_by; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_explores.created_at; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_explores.name; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_explores.description; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_explores.metadata; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_queries; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.saved_queries OWNER TO postgres;

--
-- Name: TABLE saved_queries; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.created_by; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.created_at; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.name; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.description; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.sql; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: COLUMN saved_queries.metadata; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: schema_introspection; Type: VIEW; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.schema_introspection OWNER TO postgres;

--
-- Name: service_auth_credential_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.service_auth_credential_types OWNER TO postgres;

--
-- Name: user_mgmt_pg_users; Type: VIEW; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.user_mgmt_pg_users OWNER TO postgres;

--
-- Name: vendor_types; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.vendor_types OWNER TO postgres;

--
-- Name: vendors; Type: TABLE; Schema: mergestat; Owner: postgres
--
...
ALTER TABLE mergestat.vendors OWNER TO postgres;

--
-- Name: _mergestat_explore_file_metadata; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public._mergestat_explore_file_metadata OWNER TO postgres;

--
-- Name: TABLE _mergestat_explore_file_metadata; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.repo_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.path; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_hash; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_message; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_author_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_author_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_author_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_committer_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_committer_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_committer_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata.last_commit_parents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_file_metadata._mergestat_synced_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: _mergestat_explore_repo_metadata; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public._mergestat_explore_repo_metadata OWNER TO postgres;

--
-- Name: TABLE _mergestat_explore_repo_metadata; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.repo_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_hash; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_message; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_author_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_author_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_author_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_committer_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_committer_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_committer_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata.last_commit_parents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN _mergestat_explore_repo_metadata._mergestat_synced_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: git_commit_stats; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.git_commit_stats OWNER TO postgres;

--
-- Name: TABLE git_commit_stats; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.repo_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.commit_hash; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.file_path; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.additions; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.deletions; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats._mergestat_synced_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.old_file_mode; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commit_stats.new_file_mode; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE git_commits; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.repo_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.hash; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.message; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.author_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.author_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.author_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.committer_name; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.committer_email; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.committer_when; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits.parents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_commits._mergestat_synced_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: git_files; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.git_files OWNER TO postgres;

--
-- Name: TABLE git_files; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_files.repo_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_files.path; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_files.executable; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_files.contents; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN git_files._mergestat_synced_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE schema_migrations_history; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: job_log_ordering; Type: SEQUENCE; Schema: sqlq; Owner: postgres
--
...
ALTER TABLE sqlq.job_log_ordering OWNER TO postgres;

--
-- Name: job_logs; Type: TABLE; Schema: sqlq; Owner: postgres
--
...
ALTER TABLE sqlq.job_logs OWNER TO postgres;

--
-- Name: queues; Type: TABLE; Schema: sqlq; Owner: postgres
--
...
ALTER TABLE sqlq.queues OWNER TO postgres;

--
-- Name: repo_sync_logs id; Type: DEFAULT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue id; Type: DEFAULT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_image_types container_image_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_images container_images_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_executions container_sync_executions_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_schedules container_sync_schedules_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_syncs container_syncs_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: providers providers_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: query_history query_history_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_import_types repo_import_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_imports repo_imports_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_log_types repo_sync_log_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_logs repo_sync_logs_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue repo_sync_queue_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue_status_types repo_sync_queue_status_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_syncs repo_sync_settings_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_groups repo_sync_type_groups_group_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_label_associations repo_sync_type_label_associations_label_repo_sync_type_key; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_labels repo_sync_type_labels_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_types repo_sync_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_syncs repo_syncs_repo_id_sync_type_key; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_explores saved_explores_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_queries saved_queries_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: service_auth_credential_types service_auth_credential_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: service_auth_credentials service_auth_credentials_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: sync_variables sync_variables_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_images unique_container_images_name; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_images unique_container_images_url; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_schedules unique_container_sync_schedule; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_syncs unq_repo_image; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: providers uq_providers_name; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: vendor_types vendor_types_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: vendors vendors_pkey; Type: CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: _mergestat_explore_file_metadata _mergestat_explore_file_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: _mergestat_explore_repo_metadata _mergestat_explore_repo_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: git_commit_stats commit_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: git_commits commits_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: git_files files_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: job_logs job_logs_pkey; Type: CONSTRAINT; Schema: sqlq; Owner: postgres
--
...
--
-- Name: jobs jobs_pkey; Type: CONSTRAINT; Schema: sqlq; Owner: postgres
--
...
--
-- Name: queues queues_pkey; Type: CONSTRAINT; Schema: sqlq; Owner: postgres
--
...
--
-- Name: idx_repo_sync_logs_repo_sync_created_at; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_logs_repo_sync_queue_id; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_logs_repo_sync_queue_id_fkey; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_queue_created_at; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_queue_done_at; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_queue_repo_sync_id_fkey; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_queue_status; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: idx_repo_sync_settings_repo_id_fkey; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: ix_single_default_per_provider; Type: INDEX; Schema: mergestat; Owner: postgres
--
...
--
-- Name: commits_author_when_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_commit_stats_repo_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_commits_repo_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_files_repo_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_gist_git_files_path; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_git_commit_stats_repo_id_hash_file_path; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_git_commits_repo_id_hash_parents; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_repos_repo_import_id_fkey; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: repos_repo_ref_unique; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ix_job_logs_job_level; Type: INDEX; Schema: sqlq; Owner: postgres
--
...
--
-- Name: ix_jobs_queue_type_status; Type: INDEX; Schema: sqlq; Owner: postgres
--
...
--
-- Name: ix_logs_job; Type: INDEX; Schema: sqlq; Owner: postgres
--
...
--
-- Name: repo_sync_queue repo_sync_queue_status_update_trigger; Type: TRIGGER; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_imports set_mergestat_repo_imports_updated_at; Type: TRIGGER; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TRIGGER set_mergestat_repo_imports_updated_at ON repo_imports; Type: COMMENT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_images fk_container_image_type; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_executions fk_execution_job; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_executions fk_execution_sync; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: service_auth_credentials fk_providers_credentials_provider; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_imports fk_providers_repo_imports_provider; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_sync_schedules fk_schedule_sync; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_syncs fk_sync_container; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: container_syncs fk_sync_repository; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: providers fk_vendors_providers_vendor; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: vendors fk_vendors_type; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_syncs last_completed_repo_sync_queue_id_fk; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_logs repo_sync_logs_log_type_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_logs repo_sync_logs_repo_sync_queue_id_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue repo_sync_queue_repo_sync_id_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue repo_sync_queue_status_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_queue repo_sync_queue_type_group_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_syncs repo_sync_settings_repo_id_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_label_associations repo_sync_type_label_associations_label_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_type_label_associations repo_sync_type_label_associations_repo_sync_type_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_sync_types repo_sync_types_type_group_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: repo_syncs repo_syncs_sync_type_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: service_auth_credentials service_auth_credentials_type_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: sync_variables sync_variables_repo_id_fkey; Type: FK CONSTRAINT; Schema: mergestat; Owner: postgres
--
...
--
-- Name: _mergestat_explore_file_metadata _mergestat_explore_file_metadata_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: _mergestat_explore_repo_metadata _mergestat_explore_repo_metadata_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: repos fk_repos_provider; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: git_commit_stats git_commit_stats_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: git_files git_files_repo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: repos repos_repo_import_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: job_logs job_logs_job_fkey; Type: FK CONSTRAINT; Schema: sqlq; Owner: postgres
--
...
--
-- Name: jobs jobs_queue_fkey; Type: FK CONSTRAINT; Schema: sqlq; Owner: postgres
--
...
--
-- Name: query_history; Type: ROW SECURITY; Schema: mergestat; Owner: postgres
--

ALTER TABLE mergestat.query_history ENABLE ROW LEVEL SECURITY;

--
-- Name: query_history query_history_access; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_explores; Type: ROW SECURITY; Schema: mergestat; Owner: postgres
--

ALTER TABLE mergestat.saved_explores ENABLE ROW LEVEL SECURITY;

--
-- Name: saved_explores saved_explores_all_access; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_explores saved_explores_all_access_admin; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_explores saved_explores_all_view; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_queries; Type: ROW SECURITY; Schema: mergestat; Owner: postgres
--

ALTER TABLE mergestat.saved_queries ENABLE ROW LEVEL SECURITY;

--
-- Name: saved_queries saved_queries_all_access; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_queries saved_queries_all_access_admin; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: saved_queries saved_queries_all_view; Type: POLICY; Schema: mergestat; Owner: postgres
--
...
--
-- Name: SCHEMA mergestat; Type: ACL; Schema: -; Owner: postgres
--
...
--
-- Name: SCHEMA sqlq; Type: ACL; Schema: -; Owner: postgres
--
...
--
-- Name: TABLE service_auth_credentials; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE sync_variables; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE container_syncs; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_queue; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE jobs; Type: ACL; Schema: sqlq; Owner: postgres
--
...
--
-- Name: TABLE container_image_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE container_images; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE container_sync_executions; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE container_sync_schedules; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE latest_repo_syncs; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE providers; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE query_history; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_import_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_imports; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_log_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_logs; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: SEQUENCE repo_sync_logs_id_seq; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: SEQUENCE repo_sync_queue_id_seq; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_queue_status_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_type_groups; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_type_label_associations; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_type_labels; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_sync_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE repo_syncs; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE saved_explores; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE saved_queries; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE schema_introspection; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE service_auth_credential_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE user_mgmt_pg_users; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE vendor_types; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE vendors; Type: ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: TABLE _mergestat_explore_file_metadata; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE _mergestat_explore_repo_metadata; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE git_commit_stats; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE git_commits; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE git_files; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE schema_migrations_history; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE schema_migrations_history_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: SEQUENCE job_log_ordering; Type: ACL; Schema: sqlq; Owner: postgres
--
...
--
-- Name: TABLE job_logs; Type: ACL; Schema: sqlq; Owner: postgres
--
...
--
-- Name: TABLE queues; Type: ACL; Schema: sqlq; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: mergestat; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: sqlq; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: sqlq; Owner: postgres
--
